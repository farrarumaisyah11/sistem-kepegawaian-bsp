...
<div class="container pt-1 pb-4">
    ...
    @php
        ...
        $pendidikans = old('pendidikan', optional($pegawai->pendidikan)->toArray() ?: [[]]);
        $kursus      = old('kursus', optional($pegawai->kursus)->toArray() ?: [[]]);
        $bsp         = old('peng_bsp', optional($pegawai->pengalamanBsp)->toArray() ?: [[]]);
        $luar        = old('peng_luar', optional($pegawai->pengalamanLuarBsp)->toArray() ?: [[]]);
        $keluarga    = old('keluarga', optional($pegawai->keluarga)->toArray() ?: [[]]);
        $penilaian   = old('penilaian', optional($pegawai->penilaian)->toArray() ?: [[]]);
    @endphp
    ...
    <form action="{{ route($routePrefix.'.pegawai.update', $pegawai->nip) }}" method="POST" enctype="multipart/form-data" id="form-karyawan" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="form-action-bar">
            <div class="form-action-inner">
                <div class="form-action-left">
                    Pastikan seluruh data sudah sesuai sebelum diperbarui.
                </div>
